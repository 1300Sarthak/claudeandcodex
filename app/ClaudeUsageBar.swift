...
class AppDelegate: NSObject, NSApplicationDelegate {
    ...
    func createSparkIcon(color: NSColor) -> NSImage {
        ...
        color.setFill()
        NSBezierPath(roundedRect: NSRect(x: 1, y: 1, width: 3.5, height: 5),  xRadius: 1, yRadius: 1).fill()
        NSBezierPath(roundedRect: NSRect(x: 6, y: 1, width: 3.5, height: 8),  xRadius: 1, yRadius: 1).fill()
        NSBezierPath(roundedRect: NSRect(x: 11, y: 1, width: 3.5, height: 13), xRadius: 1, yRadius: 1).fill()
        image.unlockFocus()
